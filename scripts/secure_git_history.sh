...
echo "  2. Update your .env file with the new SUPABASE_DB_URL and RAILWAY_DB_URL"
echo "  3. Test your scripts with environment variables:"
echo "     SUPABASE_DB_URL='your_supabase_url' RAILWAY_DB_URL='your_railway_url' python3 scripts/verify_migration.py"
echo ""
