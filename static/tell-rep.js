...
(() => {
  ...
  async function generateEmail(section, billId, primaryRep, ccReps) {
    ...
    try {
      ...
      const supportArg = `I SUPPORT this bill. After reviewing the full text and summary of this legislation, I believe it addresses an important issue and would benefit Americans. I encourage you to support its passage.`;
