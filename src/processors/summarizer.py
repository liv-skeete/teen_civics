...
def _build_enhanced_system_prompt() -> str:
    ...
    return (
        ...
        "- Loses: advertisers losing the loudness-grabs-attention tactic; streaming platforms facing new FCC compliance costs.\n\n"
        "🔑 What it does\n"
        "- Extends the 2010 CALM Act to internet-delivered video (YouTube, Hulu, Netflix, Disney+).\n"
        ...
        "⚖️ Who wins, who loses\n"
        "- Wins: dental health groups, the CDC, families relying on public water systems for cavity prevention.\n"
